...
ggsave(g1_combined,device="eps",dpi=300,width = 7.7, height = 5, units = "in",limitsize=TRUE,file="Fig1-gray.eps")
ggsave(g1_combined,device="tiff",dpi=300,width = 7.7, height = 5, units = "in",limitsize=FALSE,file="Fig1-gray.tif")
