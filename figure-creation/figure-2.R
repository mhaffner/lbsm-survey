...
ggsave(g1_combined,device="eps",dpi=300,width = 7.7, height = 5, units = "in",limitsize=TRUE,file="Fig2.eps")
ggsave(g1_combined,device="tiff",dpi=300,width = 7.7, height = 5, units = "in",limitsize=FALSE,file="Fig2.tif")
